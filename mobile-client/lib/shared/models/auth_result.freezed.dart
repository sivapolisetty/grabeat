...
class _$AuthSuccessImpl extends AuthSuccess {
  const _$AuthSuccessImpl(this.user) : super._();
...
abstract class AuthSuccess extends AuthResult {
...
class _$AuthFailureImpl extends AuthFailure {
  const _$AuthFailureImpl(this.error) : super._();
...
abstract class AuthFailure extends AuthResult {
